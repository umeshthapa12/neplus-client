...
import { MailTemplateState } from './store/mail-template.store';

@NgModule({

    declarations: [MailTemplateComponent, MailtemplateFormComponent, ExpandedComponent],
    entryComponents: [MailtemplateFormComponent],
    imports: [
        CommonModule,
        FormsModule,
        ReactiveFormsModule,
